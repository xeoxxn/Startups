...
// Servo adjustment
#define _DUTY_MAX 2120  // Servo angle: D degree
#define _DUTY_NEU 1320  // Servo angle: 0 degree
#define _DUTY_MIN 420// Servo angle: E degree
#define _SERVO_ANGLE_DIFF 90 // Replace with |D - E| degree
#define _SERVO_SPEED 1000 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE_UP 200
#define _BANGBANG_RANGE_DOWN 450
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 425 + 2 * a_value + -0.0206 * pow(a_value, 2) + 4.73 * pow(10, -5) * pow(a_value, 3) + -3.42 * pow(10, -8) * pow(a_value, 4) + 6.6;
}
